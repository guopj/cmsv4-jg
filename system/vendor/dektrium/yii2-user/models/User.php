...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * @return bool Whether the user is an editor or not.
     */
    ...
    /**
     * @return bool Whether the user is an developer or not.
     */
    ...
    public function rules()
    {
        return [
            ...
            //realname rules
            ['realname', 'required', 'on' => ['create', 'update']],
